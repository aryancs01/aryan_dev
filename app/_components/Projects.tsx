...
export default function Header(){
    return <div className={`flex flex-col gap-5 my-16 ${monoSpace.className}`}>
        ...
        <div className="p-2 flex flex-col gap-y-5">
            <ShowProjects 
                title="dev.learn" 
                description="Dev.learn is a simple and powerful education platform where you can explore courses across different topics. Keep track of your progress with a clear and personalized dashboard. Signing in is easy with email or GitHub, and payments are secure with Stripe."
                live="https://dev-learn-sandy.vercel.app/"
                github="https://github.com/aryancs01/dev.learn"
                imageSrc="/devlearn.png"
                />
            <ShowProjects 
                title="Canva" 
                description="This Canva clone is a simple and powerful design tool for creating stunning visuals.
                        Browse and import high-quality images from Unsplash instantly.
                        Edit with advanced filters and tools to customize your designs.
                        Payments are fast and secure with Stripe, built using Next.js and Hono."
                live="https://canva0.vercel.app/"
                github="https://github.com/aryancs01/canvas-clone-ai"
                imageSrc="/canva.png"
                />
        </div>
    </div>
...
function ShowProjects({title, description, live, github, imageSrc}:iAppProps){
