...
export default function Header(){
    return <div className={`w-full flex flex-col gap-5 mb-10 mt-10 ${monoSpace.className}`}>
        ...
        <div className="flex flex-col gap-2">
            <p className="text-green-500">I’m currently available for internships, full-time opportunities, and freelance projects. </p>
            <Link href="mailto:aryan1032saxena@gmail.com" className="text-green-400 border border-gray-400 rounded-md p-2 w-[100px] text-center bg-[#242323]">
                Hire me
            </Link>
        </div>
    </div>
